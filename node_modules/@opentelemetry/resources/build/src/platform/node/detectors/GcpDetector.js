...
class GcpDetector {
    async detect() {
        ...
        const labels = {};
        labels[constants_1.CLOUD_RESOURCE.ACCOUNT_ID] = projectId;
        labels[constants_1.HOST_RESOURCE.ID] = instanceId;
        labels[constants_1.CLOUD_RESOURCE.ZONE] = zoneId;
        labels[constants_1.CLOUD_RESOURCE.PROVIDER] = 'gcp';
    ...
    _addK8sLabels(labels, clusterName) {
        labels[constants_1.K8S_RESOURCE.CLUSTER_NAME] = clusterName;
        labels[constants_1.K8S_RESOURCE.NAMESPACE_NAME] = process.env.NAMESPACE || '';
        labels[constants_1.K8S_RESOURCE.POD_NAME] = process.env.HOSTNAME || os.hostname();
        labels[constants_1.CONTAINER_RESOURCE.NAME] = process.env.CONTAINER_NAME || '';
    }
